...
class OaiCaller():
    ...
    def learn_more(self, abstract: str):
        if abstract is None or abstract == "":
            return ""
        prompt = abstract + "\n\nPlease provide educational resources (including articles, books, videos, and more) to help understand the concepts described in the above abstract. Do not provide links, and provide numbered bullet points."
        model_output = self.callModel(prompt)
